...
import {ActionEntity, ActionType, ComboPointActionEntity, DamageActionEntity, EffectActionEntity, EffectEntity, HealActionEntity, ModifierCategoryType} from "../gql/sdk";
...
module Action {
  ...
  function executeComboPoint({modifier_list, base_value, ...action}: ComboPointActionEntity, target_unit: Unit, source: Source): void {
    ...
    const applied_value = Modifier.getCategoryValue(ModifierCategoryType.ComboPointChange, modifier_list, source.unit) + base_value;
  ...
  export function executeEffect({effect, modifier_list}: EffectActionEntity, target_unit: Unit, source: Source) {
    ...
    const duration = Modifier.getCategoryValue(ModifierCategoryType.EffectDuration, modifier_list, source.unit);
