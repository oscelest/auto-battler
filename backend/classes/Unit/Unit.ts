...
import {AttributeType, DamageElementType, DamageSourceType, EffectEntity, ModifierCategoryType, ModifierEntity, SkillEntity, UnitEntity} from "../../gql/sdk";
...
import {isSkillEntity, SkillComboPointEvent, SkillInitializer} from "../Skill/Skill";
...
export default class Unit extends EntityEventElement<UnitEntity, UnitEventHandler> {
  ...
  constructor(initializer: UnitInitializer) {
    ...
    this.health = initializer.health ?? this.getAttributeValue(AttributeType.Health);
  ...
  public get modifier_list(): ModifierEntity[] {
    return [
      ...this.entity.type.modifier_list,
  ...
  public getAttributeValue(attribute: AttributeType) {
  ...
  public receiveDamageFrom(source: Source, action: UnitDamageAction): number {
    ...
    const armor = Modifier.getCategoryValue([ModifierCategoryType.UnitAttributeArmor], this.modifier_list, this);
  ...
  public receiveHealingFrom(source: Source, action: UnitHealAction): number {
    ...
    const max_heath = Modifier.getCategoryValue(ModifierCategoryType.UnitAttributeHealth, modifier_list, this);
