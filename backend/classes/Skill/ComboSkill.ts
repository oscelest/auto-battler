...
import {ModifierCategoryType} from "../../gql/sdk";
...
export default class ComboSkill extends Skill {
  ...
  public get combo_point_max() {
    return this.getCategoryValue(ModifierCategoryType.ComboPointMax, this.unit);
  }
  ...
  private readonly onComboPointReceived = () => {
    ...
    if (this.combo_point_current >= combo_point_max) {
      ...
      const combo_point_retain = this.getCategoryValue(ModifierCategoryType.ComboPointRetain, this.unit);
